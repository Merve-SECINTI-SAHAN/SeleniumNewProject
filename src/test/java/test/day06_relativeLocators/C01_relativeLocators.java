package test.day06_relativeLocators;
...
public class C01_relativeLocators {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
        XPATH kullanımında bir sayfadaki webelementlere müdahale etmek istediğimizde xpath ile locate aldığımızda birden fazla sonuç verebilir.
        [position()>=10 and position()<=16]  bu kullanımla aralık belirterek istediğimiz WE leri seçip müdahale edebiliriz.
         */
